 ...
 */
package com.hcentive.utils.orm.dao;
...
public interface GenericDAO<T extends Serializable> {
	...
	public List<T> findPaginatedByNamedQuery(final String queryName, int startPosition, int maxResult, final String[] paramNames,
	 ...
	 * @return the list< t>
	 */
	List<T> findByNamedQuery(String queryName, Map<String, Object> params, int startPosition, int maxResult);
