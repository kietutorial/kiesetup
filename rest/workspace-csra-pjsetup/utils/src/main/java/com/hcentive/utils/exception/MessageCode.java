...
public class MessageCode {
	...
	public boolean equals(Object obj) {
		...
		return this.name.equals(((MessageCode) obj).getName())
				&& this.defaultMessage.equals(((MessageCode) obj).getDefaultMessage());
	}

	@Override
	public int hashCode() {
		return 1; // All MessageCode objects will hv the same hashcode so
					// equality determined by equals method
	}
}
