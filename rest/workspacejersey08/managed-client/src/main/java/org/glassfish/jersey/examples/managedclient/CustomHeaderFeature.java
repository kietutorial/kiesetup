...
/**
 * Dynamic feature that appends a properly configured {@link CustomHeaderFilter}
 * instance to every method that is annotated with {@link Require &#64;Require}
 * internal feature annotation.
 *
...
public class CustomHeaderFeature implements DynamicFeature {
	...
	/**
	 * A method annotation to be placed on those resource methods to which a
	 * validating {@link CustomHeaderFilter} instance should be added.
	 */
